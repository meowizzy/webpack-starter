jQuery(document).ready(function ($) {
    ...
    var paymentHead = $('.payment-details__head');
    ...
    if (statusCode && !billId) {
        paymentHead.addClass('d-none');
        mainLoading.addClass('d-none');
        mainWrap.removeClass('d-none');
        paymentStatus.addClass(statusCode);

        paymentFinishState.removeClass('d-none');
        paymentFinishState.addClass(statusCode);
    }
